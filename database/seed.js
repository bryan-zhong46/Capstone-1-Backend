  ...
  try {
    ...
    const polls = await Poll.bulkCreate([
      { creator_id: users[0].user_id, 
        title: "Best City", 
        description: "Rank the best city from best (smallest number) to worst (largest number)!", 
        number_of_votes: 0, 
        auth_required: false, 
        poll_status: 'draft'},
      { creator_id: users[1].user_id, 
        title: "Best Food", 
        description: "Rank the best foods from best (smallest) to worst (largest)!", 
        number_of_votes: 0, 
        auth_required: false, 
