...
const seed = async () => {
  try {
    ...
    const options = await Option.bulkCreate([
      ...
      { poll_id: polls[1].poll_id, option_text: "Yellow Rice and Chicken" },
      { poll_id: polls[1].poll_id, option_text: "Tacos" },
    ]);
